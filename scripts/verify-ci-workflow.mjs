...
const requiredSnippets = [
  ...
  "--bundles app,dmg",
  "--bundles nsis",
  "portableGlob: src-tauri/target/x86_64-pc-windows-msvc/release/HomeNet.exe",
  "portableGlob:",
  "installerGlob:",
  "updaterGlob:",
  "updaterSuffix:",
  ...
  "updater_enabled: ${{ steps.updater.outputs.updater_enabled }}",
...
const forbiddenSnippets = [
  ...
  "HOMENET_UPDATER_PUBLIC_KEY secret is required for updater-enabled release builds.",
  "TAURI_SIGNING_PRIVATE_KEY secret is required for updater-enabled release builds.",
  "tauri_config_args",
